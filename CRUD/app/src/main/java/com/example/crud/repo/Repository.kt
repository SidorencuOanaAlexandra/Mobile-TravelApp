...
import com.example.crud.repo.roomRepo.TravelPlaceDao
...
class Repository(private val travelPlaceDao: TravelPlaceDao){

    val list_TravelPlaces: LiveData<List<TravelPlace>> = travelPlaceDao.getAll();

//    @Suppress("RedundantSuspendModifier")
//    @WorkerThread
    suspend fun Add(word: TravelPlace) {
        travelPlaceDao.insert(word)
    }

   // suspend fun getAllData() = list_TravelPlaces
